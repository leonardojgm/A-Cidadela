...
function retornarPagina() {
	...
	var paginaEsquerda = parseInt(imgEsquerda.substring(10,14)) - 2;
	if (paginaEsquerda >= 0) {	
		...
		$('#img-esquerda').attr('src','./Paginas/'+novaImgEsquerda+'.jpg');
		$('#img-direita').attr('src','./Paginas/'+novaImgDireita+'.jpg');
...
function primeiraPagina() {
	$('.comecar').show();
	$('.ficha-completa').hide();
	$('#img-esquerda').attr('src','./Paginas/0000.jpg');
	$('#img-direita').attr('src','./Paginas/0001.jpg');
...
function mostrarRegras() {
	...
	$('#retornar').show();
	$('.ficha-completa').hide();
	$('#img-esquerda').attr('src','./Paginas/0006.jpg');
	$('#img-direita').attr('src','./Paginas/0007.jpg');
...
function rolarUmDado() {
	var dado1 = rolarDado();
	$('#img-1dado').attr('src','./Dados/'+dado1+'.jpg');
	$('#img-2dado').attr('src','./Dados/0.jpg');
	return dado1;
};
function rolarDoisDados() {
	...
	var dado2 = rolarDado();
	$('#img-1dado').attr('src','./Dados/'+dado1+'.jpg');
	$('#img-2dado').attr('src','./Dados/'+dado2+'.jpg');
	return dado1 + dado2;
};
...
function irIndice(indiceDestino) {
	...
	if (indiceDestino === -1) {
		...
		$('#img-esquerda').attr('src','./Paginas/0012.jpg');
		$('#img-direita').attr('src','./Paginas/0013.jpg');
